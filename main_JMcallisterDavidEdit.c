...
//Note, for our puprose there aren't any exceptions that we could handle that I can think of except SEGFAULT, which we have been careful to check for,
...
// TODO: Determine t eproper place to free memory...